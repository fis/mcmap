...
enum packet_id
{
	...
	PACKET_BETA_INVENTORY_CLOSE = 0x65,
	PACKET_BETA_INVENTORY_CLICK = 0x66,
	PACKET_BETA_UNKNOWN1 = 0x67,
	PACKET_BETA_INVENTORY_DATA = 0x68,
	PACKET_BETA_INVENTORY_ACK = 0x6a,
	PACKET_BETA_UNKNOWN2 = 0xae,
